...
class CDbCommand extends CComponent
{
    ...
    /*
    if (Helper::isCli()) {
      file_put_contents('/home/webuser/rivori/protected/runtime/log/log.db',  $this->getText().$par."\r\n", FILE_APPEND);
    }
    */
		...
		{
			if($this->_connection->enableProfiling) {
        $par .= " | connection = ".$this->connection->connectionString;
//        $e = new Exception();
//        $par .= $e->getTraceAsString();
