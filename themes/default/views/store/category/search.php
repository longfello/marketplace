	...
	<div class="products_list">
		...
		<div class="actions">
          ...
          Yii::app()->request->addUrlParam('/store/category/search', array('sort'=>'price'))  => Yii::t('StoreModule', 'Сначала дешевые'),
					...
					Yii::app()->request->addUrlParam('/store/category/search', array('sort'=>'views_count.desc')) => Yii::t('StoreModule', 'Сначала популярные'),
					Yii::app()->request->addUrlParam('/store/category/search', array('sort'=>'created.desc')) => Yii::t('StoreModule', 'Сначала последние добавленные'),
