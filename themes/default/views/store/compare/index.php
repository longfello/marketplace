...
$this->pageTitle = Yii::t('StoreModule', 'Сравнение продуктов');
?>

<h1 class="has_background"><?php echo Yii::t('StoreModule', 'Сравнение продуктов') ?></h1>
...
<div style="width: 900px; overflow:auto;">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					echo $value===null ? Yii::t('StoreModule','Не указано') : $value;
					?>
				</td>
				<?php endforeach; ?>
			</tr>
	...
	<?php else: ?>
		<?php echo Yii::t('StoreModule','Нет результатов.'); ?>
	<?php endif ?>
</div>