...
<div class="item product_block">
  <div class="type">
    <div class="type-text"><?=($data->mainCategory)?$data->mainCategory->name:"&nbsp;"?></div>
    <div class="type-back"></div>
    <?php if ($data->discount) { ?>
      <div class="skidka"><?=$data->discount?></div>
      <div class="skidka-back"></div>
    <?php } ?>
  </div>
  <div class="image">
    <?php
      if($data->mainImage)
        $imgSource = $data->mainImage->getUrl('150x90');
      else
  ...
  <div class="item-name"><?php echo CHtml::link(CHtml::encode($data->name), array('frontProduct/view', 'url'=>$data->url)) ?></div>
  <div class="rating">
