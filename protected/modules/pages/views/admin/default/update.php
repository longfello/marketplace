<?php
	...
	$title = ($model->isNewRecord) ? Yii::t('PagesModule', 'Создание страницы') :
		Yii::t('PagesModule', 'Редактирование страницы');

	$this->breadcrumbs = array(
		'Home'=>$this->createUrl('/admin'),
		Yii::t('PagesModule', 'Страницы')=>$this->createUrl('index'),
		($model->isNewRecord) ? Yii::t('PagesModule', 'Создание страницы') : CHtml::encode($model->title),
	);
