...
class PagesController extends Controller
{
	...
	public function actionList()
	{
		...
		if (!$model) throw new CHttpException(404, Yii::t('PagesModule', 'Категория не найдена.'));
	...
	public function actionView($url)
	{
		...
		if (!$model) throw new CHttpException(404, Yii::t('PagesModule', 'Страница не найдена.'));
