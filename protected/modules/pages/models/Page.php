...
class Page extends BaseModel
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'user_id' => Yii::t('PagesModule', 'Автор'),
			'category_id' => Yii::t('PagesModule', 'Категория'),
			'title' => Yii::t('PagesModule', 'Заглавление'),
			'url' => Yii::t('PagesModule', 'URL'),
			'short_description' => Yii::t('PagesModule', 'Краткое описание'),
			'full_description' => Yii::t('PagesModule', 'Содержание'),
			'meta_title' => Yii::t('PagesModule', 'Meta Title'),
			'meta_description' => Yii::t('PagesModule', 'Meta Description'),
			'meta_keywords' => Yii::t('PagesModule', 'Meta Keywords'),
			'created' => Yii::t('PagesModule', 'Дата создания'),
			'updated' => Yii::t('PagesModule', 'Дата обновления'),
			'publish_date' => Yii::t('PagesModule', 'Дата публикации'),
			'status' => Yii::t('PagesModule', 'Статус'),
			'layout' => Yii::t('PagesModule', 'Макет'),
			'view' => Yii::t('PagesModule', 'Шаблон'),
		);
	}
	...
	{
		return array(
			'published'=>Yii::t('PagesModule', 'Опубликован'),
			'waiting'=>Yii::t('PagesModule', 'Ждет одобрения'),
			'draft'=>Yii::t('PagesModule', 'Черновик'),
			'archive'=>Yii::t('PagesModule', 'Архив'),
		);
	}
