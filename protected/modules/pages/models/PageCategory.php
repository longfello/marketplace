...
class PageCategory extends BaseModel
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'parent_id' => Yii::t('PagesModule', 'Родитель'),
			'name' => Yii::t('PagesModule', 'Название'),
			'url' => Yii::t('PagesModule', 'URL'),
			'description' => Yii::t('PagesModule', 'Описание'),
			...
			'pages' => Yii::t('PagesModule', 'Страницы'),
			'page_size' => Yii::t('PagesModule', 'Записей на странице'),
		);
	}
