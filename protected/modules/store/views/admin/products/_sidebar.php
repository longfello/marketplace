<h3><?php echo Yii::t('StoreModule', 'Поиск по категории') ?></h3>
...
<div class="form wide">
	...
	<?php
		...
		$this->widget('zii.widgets.jui.CJuiButton', array(
			'name'=>'button1',
			'buttonType'=>'button',
			'caption'=>Yii::t('StoreModule', 'Развернуть все'),
			'onclick'=>'js:function(){
		...
		$this->widget('zii.widgets.jui.CJuiButton', array(
			'name'=>'button12',
			'buttonType'=>'button',
			'caption'=>Yii::t('StoreModule', 'Свернуть все'),
			'onclick'=>'js:function(){
...
$("#StoreCategoryTreeFilter").bind("loaded.jstree", function (event, data) {
	$(this).jstree("create",-1,false,{attr:{id:"StoreCategoryTreeFilterNode_0"}, data:{title:"'.Yii::t('StoreModule', 'Все категории').'"}},false,true);
