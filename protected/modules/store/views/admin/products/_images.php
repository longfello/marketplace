...
echo CHtml::label(Yii::t('StoreModule', 'Выберите изображения'), 'files');
...
if ($model->images)
{
	foreach($model->images as $image)
	{
		$this->widget('zii.widgets.CDetailView', array(
			...
			'attributes'=>array(
				array(
					'label'=>Yii::t('StoreModule', 'Изображение'),
					'type'=>'raw',
					'value'=>CHtml::link(
				...
				'date_uploaded',
				array(
					'label'=>Yii::t('StoreModule', 'Название'),
					'type'=>'raw',
					'value'=>CHtml::textField('image_titles['.$image->id.']', $image->title),
				),
				array(
					'label'=>Yii::t('StoreModule', 'Действия'),
					'type'=>'raw',
					'value'=>CHtml::ajaxLink(Yii::t('StoreModule', 'Удалить'),$this->createUrl('deleteImage', array('id'=>$image->id)),
						array(
							'type'=>'POST',
						...
						array(
							...
							'confirm'=>Yii::t('StoreModule', 'Вы действительно хотите удалить это изображение?'),
						)
					),
				),
			),
