...
$title = ($model->isNewRecord) ? Yii::t('StoreModule', 'Создание способа оплаты') :
	Yii::t('StoreModule', 'Редактирование способа оплаты');

$this->breadcrumbs = array(
	'Home'=>$this->createUrl('/admin'),
	Yii::t('StoreModule', 'Способы оплаты')=>$this->createUrl('index'),
	($model->isNewRecord) ? Yii::t('StoreModule', 'Создание способа оплаты') : CHtml::encode($model->name),
);
