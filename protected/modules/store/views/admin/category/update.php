...
$title = ($model->isNewRecord) ? Yii::t('StoreModule', 'Создание категории') :
	Yii::t('StoreModule', 'Редактирование категории');

$this->breadcrumbs = array(
	'Home'=>$this->createUrl('/admin'),
	Yii::t('StoreModule', 'Категории')=>$this->createUrl('index'),
	($model->isNewRecord) ? Yii::t('StoreModule', 'Создание категории') : CHtml::encode($model->name),
);
