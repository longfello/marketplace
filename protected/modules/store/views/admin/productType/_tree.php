<div class="form wide">
	<?php echo Yii::t('StoreModule', 'Поиск:') ?> <input type="text" onkeyup='$("#StoreTypeCategoryTree").jstree("search", $(this).val());' />
</div>
...
<div class="hint" style="margin: 0">
	<br><?php echo Yii::t('StoreModule',"Здесь вы можете указать категории, которые будут автоматически выбраны при создании продукта."); ?>
	<br><?php echo Yii::t('StoreModule',"Нажмите на название категории, чтобы сделать её главной."); ?>
</div>