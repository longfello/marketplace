		...
		<div class="actions">
			...
			<div class="buttons">
				<div class="silver_clean silver_button <?php if($itemView==='_product_wide') echo 'active'; ?>">
					<a <?php if($itemView==='_product_wide') echo 'class="active"'; ?> href="<?php echo Yii::app()->request->addUrlParam('/store/category/view',  array('view'=>'wide')) ?>"><span class="icon lines"></span><?=Yii::t('StoreModule', 'Списком')?></a>
				</div>
				<div class="silver_clean silver_button <?php if($itemView==='_product') echo 'active'; ?>">
					<a <?php if($itemView==='_product') echo 'class="active"'; ?> href="<?php echo Yii::app()->request->removeUrlParam('/store/category/view', 'view') ?>"><span class="icon dots"></span><?=Yii::t('StoreModule', 'Картинками')?></a>
				</div>
			</div>
		</div>
