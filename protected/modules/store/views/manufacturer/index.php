	...
	<div class="products_list">
        ...
        <div class="actions">
			...
			echo CHtml::dropDownList('sorter', Yii::app()->request->url, array(
				...
				Yii::app()->request->addUrlParam('/store/manufacturer/index', array('sort'=>'price'))  => Yii::t('StoreModule', 'Сначала дешевые'),
				Yii::app()->request->addUrlParam('/store/manufacturer/index', array('sort'=>'price.desc')) => Yii::t('StoreModule', 'Сначала дорогие'),
