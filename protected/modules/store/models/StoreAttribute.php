 ...
 * @method StoreAttribute orderByName()
 */
class StoreAttribute extends BaseModel
{
	...
	public function rules()
	{
		return array(
			...
			array('name', 'match',
				...
				'message'=>Yii::t('StoreModule', 'Название может содержать только буквы, цифры, дефис и знак подчеркивания.')
			),
	...
	public function scopes()
	{
      ...
      'orderByName'    => array('order'=> 'attr_translate.title'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id'               => 'ID',
			'name'             => Yii::t('StoreModule', 'Идентификатор'),
			'title'            => Yii::t('StoreModule', 'Название'),
			'type'             => Yii::t('StoreModule', 'Тип'),
			'display_on_front' => Yii::t('StoreModule', 'Отображать на странице продукта'),
			'position'         => Yii::t('StoreModule', 'Позиция'),
			'use_in_filter'    => Yii::t('StoreModule', 'Использовать в фильтре'),
			'use_in_variants'  => Yii::t('StoreModule', 'Использовать в вариантах'),
			'use_in_compare'   => Yii::t('StoreModule', 'Использовать в сравнении'),
			'select_many'      => Yii::t('StoreModule', 'Множественный выбор'),
			'required'         => Yii::t('StoreModule', 'Обязательно к заполнению'),
		);
	}
