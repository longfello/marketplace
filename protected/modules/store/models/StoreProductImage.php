...
class StoreProductImage extends BaseModel
{
	...
	{
		return array(
			'product_id'    => Yii::t('StoreModule', 'Продукт'),
			'name'          => Yii::t('StoreModule', 'Имя файла'),
			'is_main'       => Yii::t('StoreModule', 'Главное'),
			'author'        => Yii::t('StoreModule', 'Автор'),
			'uploaded_by'   => Yii::t('StoreModule', 'Автор'),
			'date_uploaded' => Yii::t('StoreModule', 'Дата загрузки'),
