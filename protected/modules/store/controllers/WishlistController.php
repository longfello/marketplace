...
class WishlistController extends Controller
{
	...
	{
		$this->model->add($id);
		$this->addFlashMessage(Yii::t('StoreModule', 'Продукт успешно добавлен в список желаний.'));
		if(!Yii::app()->request->isAjaxRequest)
	...
	public function actionView($key)
	{
		try{
			...
			throw new CHttpException(404, Yii::t('StoreModule', 'Ошибка. По вашему запросу ничего не найдено.'));
		}
