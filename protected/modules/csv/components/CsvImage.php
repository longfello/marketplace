...
class CsvImage extends CUploadedFile
{
	...
	public static function create($image)
	{
		...
		if($isDownloaded)
		{
      $tmpName = Yii::getPathOfAlias('application.runtime.productImages').DIRECTORY_SEPARATOR.sha1(pathinfo($image,PATHINFO_FILENAME)).'.'.pathinfo($image,PATHINFO_EXTENSION);
    ...
    /*
    print_r(Helper::toArray($result));
    print_r(Helper::toArray($result->getError()));
    */
