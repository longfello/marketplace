...
class RemindController extends Controller
{
	...
	public function actionIndex()
	{
        ...
        $this->addFlashMessage(CHtml::errorSummary($model));
			}
	...
	public function actionActivatePassword($key)
	{
		...
		{
			$this->addFlashMessage(Yii::t('UsersModule', 'Ваш новый пароль успешно активирован.'));
			$this->redirect(array('/users/login/login'));
		}else{
			$this->addFlashMessage(Yii::t('UsersModule', 'Ошибка активации пароля.'));
