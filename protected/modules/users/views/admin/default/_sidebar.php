...
$orders_msg = Yii::t('UsersModule', 'Заказов: {count} на сумму {sum} {sym}', array(
	'{count}' => sizeof($model->orders),
	'{sum}'   => StoreProduct::formatPrice($model->ordersTotalPrice),
	'{sym}'   => Yii::app()->currency->main->symbol
));

$comments_msg = Yii::t('UsersModule', 'Комментариев: {count}', array(
...
<h3><?=Yii::t('UsersModule', 'Дополнительно')?></h3>
