...
<h1><?php echo Yii::t('InstallModule','Шаг 2. Подключение к БД.') ?></h1>
...
<div class="form wide">
	...
	<div class="row buttons">
		<input type="submit" value="<?php echo Yii::t('InstallModule','Установить') ?>" onclick="this.disabled=true;this.value='Установка...';this.form.submit();">
	</div>
