...
<h1><?php echo Yii::t('InstallModule','Шаг 3. Настройка.') ?></h1>
...
<div class="form wide">
	...
	<h3><?php echo Yii::t('InstallModule','Учётная запись администратора') ?></h3>
	...
	<div class="row buttons">
		<input type="submit" value="<?php echo Yii::t('InstallModule','Сохранить') ?>">
	</div>
