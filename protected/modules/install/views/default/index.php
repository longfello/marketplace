...
<h1><?php echo Yii::t('InstallModule','Шаг 1. Проверка.') ?></h1>

<div class="line"></div>

<div class="form">
	<div class="m20">
		<?php echo Yii::t('InstallModule','Следующий список директорий и файлов должен быть доступен для записи.'); ?>
	</div>
	...
	<div class="row buttons">
		...
		<form action="" method="post">
			...
			<input type="submit" value="<?php echo Yii::t('InstallModule','Продолжить'); ?>">
		</form>
		<?php else: ?>
		<div class="m20">
			<?php echo Yii::t('InstallModule','Исправьте ошибки и нажмите <a href="/install.php">Обновить</a>'); ?>
		</div>
		<?php endif ?>
	</div>
</div>
