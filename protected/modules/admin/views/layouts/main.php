...
<div id="doc3" class="yui-t6">
	<div id="hd">
		<div class="yui-gc">
			...
			<div class="yui-u" id="topRightMenu">
				...
				<?php echo CHtml::link(Yii::t('AdminModule', 'Выход ({name})', array('{name}'=>Yii::app()->user->model->username)), array('/admin/auth/logout'), array(
					'confirm'=>Yii::t('StoreModule','Завершить сеанс?')
				)) ?>
			</div>
		</div>
	</div> <!-- /hd -->
	...
	<div id="bd" class="marleft">
		<div id="yui-main">
			<?php if (isset($this->pageHeader) && !empty($this->pageHeader)) echo '<h3>'.$this->pageHeader.'</h3>'; ?>
