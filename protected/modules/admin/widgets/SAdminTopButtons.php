...
class SAdminTopButtons extends CWidget {
	...
	public function run()
	{
		...
		if ($this->langSwitcher && count(Yii::app()->i18n->languages) > 1)
	...
	public function getDefault()
	{
		...
		return array(
			...
			'save'=>array(
				...
				'title'=>Yii::t('AdminModule', 'Сохранить'),
				'classes'=>array(),
				'htmlOptions'=>array(
			...
			'delete'=>array(
				...
				'title'=>Yii::t('AdminModule', 'Удалить'),
				'classes'=>array(),
				'htmlOptions'=>array(
					'title'=>Yii::t('AdminModule', 'Удалить'),
					'confirm'=>Yii::t('AdminModule', 'Удалить?'),
					'csrf'=>true,
					'ajax'=>array(
	...
	{
		$currentLang = Yii::app()->i18n->default;
		...
		if($this->form && isset($this->form->model) && array_key_exists('STranslateBehavior', $this->form->model->behaviors()))
		{
			...
			{
				$flagUrl = Yii::app()->getModule('admin')->assetsUrl.'/images/flags/png/'.$currentLang->code.'.png';
		...
		return array(
			...
			'options'=>array(
				'icons'=>array(
					'secondary'=>(count(Yii::app()->i18n->languages) > 1) ? 'ui-icon-triangle-1-s' : null
				)
			)
		);
	}
	 ...
	 * @return string
	 */
	public function getFlagImage($lang)
	{
		$adminAssetsUrl = Yii::app()->getModule('admin')->assetsUrl;
		if($lang->code)
		{
			return CHtml::image($adminAssetsUrl.'/images/flags/png/'.$lang->code.'.png', null, array(
				'width'=>16,
				'height'=>11,
				'align'=>'absmiddle',
    ...
    $this->registerFgMenu();
		if (in_array('dropDown', $this->template))
		{
			...
			$dropDownItems = array(
				array(
					'label'=>Yii::t('AdminModule', 'Сохранить и создать'),
				...
				array(
					'label'=>Yii::t('AdminModule', 'Сохранить и редактировать'),
