...
class DefaultController extends SAdminController
{
	...
	public function actionSend()
	{
		...
		foreach ($record as $row)
		{
			...
			$theme = Yii::t('NotifierModule', '{site_name} уведомляет о наличии интересующего Вас продукта',array(
				'{site_name}' => $siteName
			));
		...
		$this->setFlashMessage(Yii::t('NotifierModule', 'Сообщения успешно отправлены.'));
		$this->redirect('index');
	}
