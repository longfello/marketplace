<?php
	...
	$this->pageHeader = Yii::t('NotifierModule', 'Список продуктов для уведомления');

	$this->breadcrumbs = array(
		'Home'=>$this->createUrl('/admin'),
		Yii::t('NotifierModule', 'Уведомления'),
	);
