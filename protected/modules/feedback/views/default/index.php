...
$this->pageTitle = Yii::t('FeedbackModule', 'Обратная связь');

?>

<h1 class="has_background"><?php echo Yii::t('FeedbackModule', 'Обратная связь') ?></h1>
...
<?php $form=$this->beginWidget('CActiveForm'); ?>
		...
		<div class="row buttons">
			<button type="submit" class="blue_button"><?php echo Yii::t('FeedbackModule', 'Отправить') ?></button>
		</div>
	</fieldset>
<?php $this->endWidget(); ?>
</div>