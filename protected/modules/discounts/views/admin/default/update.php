...
$title = ($model->isNewRecord) ? Yii::t('DiscountsModule', 'Создание скидки') :
	Yii::t('DiscountsModule', 'Редактирование скидки');

$this->breadcrumbs = array(
	'Home'=>$this->createUrl('/admin'),
	Yii::t('DiscountsModule', 'Скидки')=>$this->createUrl('index'),
	($model->isNewRecord) ? Yii::t('DiscountsModule', 'Создание скидки') : CHtml::encode($model->name),
);
