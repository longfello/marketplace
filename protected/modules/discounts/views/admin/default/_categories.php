...
<div class="form wide">
	<?php echo Yii::t('DiscountsModule', 'Поиск:') ?> <input type="text" onkeyup='$("#StoreDiscountCategoryTree").jstree("search", $(this).val());' />
</div>
...
<div class="hint" style="margin: 0">
	<br><?php echo Yii::t('DiscountsModule',"Здесь вы можете указать категории, для которых будет доступна скидка."); ?>
</div>