...
class Discount extends BaseModel
{
	...
	public function attributeLabels()
	{
		return array(
			'id'            => 'ID',
			'name'          => Yii::t('DiscountsModule', 'Название'),
			'active'        => Yii::t('DiscountsModule', 'Активен'),
			'sum'           => Yii::t('DiscountsModule', 'Скидка'),
			'start_date'    => Yii::t('DiscountsModule', 'Дата начала'),
			'end_date'      => Yii::t('DiscountsModule', 'Дата окончания'),
			'manufacturers' => Yii::t('DiscountsModule', 'Производители'),
			'userRoles'     => Yii::t('DiscountsModule', 'Группы пользователей'),
		);
	}
