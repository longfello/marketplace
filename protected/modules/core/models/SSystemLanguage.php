...
class SSystemLanguage extends BaseModel
{
    ...
    public function attributeLabels()
    {
        return array(
            'id'        => 'ID',
            'name'      => Yii::t('CoreModule', 'Название'),
            'code'      => Yii::t('CoreModule', 'Идентификатор'),
            'locale'    => Yii::t('CoreModule', 'Кодировка'),
            'default'   => Yii::t('CoreModule', 'По умолчанию'),
            'flag_name' => Yii::t('CoreModule', 'Флаг'),
        );
    }
