...
class YandexMarketConfigForm extends CFormModel
{
	...
	public function checkCurrency()
	{
		...
		if(!array_key_exists($this->currency_id, $currencies))
			$this->addError('currency_id', Yii::t('YandexMarketModule', 'Ошибка провеки валюты.'));
	}
	...
	{
		return array(
			'name'        => Yii::t('YandexMarketModule','Название магазина'),
			'company'     => Yii::t('YandexMarketModule','Название компании'),
			'url'         => Yii::t('YandexMarketModule','Полный URL сайта'),
			'currency_id' => Yii::t('YandexMarketModule','Валюта')
		);
	}
