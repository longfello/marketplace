...
$this->pageHeader = Yii::t('YandexMarketModule', 'Настройка Yandex.Market');

$this->breadcrumbs = array(
	'Home'=>$this->createUrl('/admin'),
	Yii::t('YandexMarketModule', 'Модули')=>Yii::app()->createUrl('/core/admin/systemModules'),
	Yii::t('YandexMarketModule', 'Настройка Yandex.Market'
));
...
<div class="form wide padding-all">
	...
	<div class="row submit">
		<label>&nbsp;</label>
		<?php echo CHtml::submitButton(Yii::t('YandexMarketModule', 'Сохранить')); ?>
	</div>
