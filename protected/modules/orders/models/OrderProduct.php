...
class OrderProduct extends BaseModel
{
	...
	public function attributeLabels()
	{
		return array(
			'id'              => 'ID',
			'order_id'        => Yii::t('OrdersModule', 'Заказы'),
			'product_id'      => Yii::t('OrdersModule', 'Продукт'),
			'configurable_id' => Yii::t('OrdersModule', 'Конфигурация'),
			'name'            => Yii::t('OrdersModule', 'Название'),
			'quantity'        => Yii::t('OrdersModule', 'Количество'),
			'sku'             => Yii::t('OrdersModule', 'Артикул'),
			'price'           => Yii::t('OrdersModule', 'Цена'),
		);
	}
