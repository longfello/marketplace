...
class PaymentController extends Controller
{
	...
	public function actionProcess()
	{
		...
		if(!$model)
			throw new CHttpException(404, Yii::t('OrdersModule', 'Ошибка'));
		...
		if($system instanceof BasePaymentSystem)
		{
			...
			if($response instanceof Order)
				...
				throw new CHttpException(404, Yii::t('OrdersModule', 'Возникла ошибка при обработке запроса. <br> {err}', array('{err}'=>$response)));
		}
	}
