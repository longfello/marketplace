...
<div class="order_products">
	...
	<div class="recount">
		<div class="silver_clean silver_button">
			<button class="recount" name="recount" type="submit" value="1"><?=Yii::t('OrdersModule', 'Пересчитать')?></button>
		</div>
		<span class="total"><?=Yii::t('OrdersModule', 'Всего')?>:</span>
		<span id="total">
...
<div class="order_data">
	<div class="left">
		<div class="delivery rc5">
			<h2><?=Yii::t('OrdersModule', 'Способ доставки')?></h2>
			<ul>
...
<div class="has_background confirm_order">
	<h1><?=Yii::t('OrdersModule', 'Всего к оплате:')?></h1>
	<span id="orderTotalPrice" class="total"><?php echo StoreProduct::formatPrice($totalPrice) ?></span>
	<span class="current_currency">
		<?php echo Yii::app()->currency->active->symbol; ?>
	</span>
	<button class="blue_button" type="submit" name="create" value="1"><?=Yii::t('OrdersModule', 'Оформить')?></button>
</div>
