	...
	<table width="100%">
		<tr valign="top">
			<td width="50%">
				<!-- User data -->
				<div class="userData">
					<h4><?php echo Yii::t('OrdersModule', 'Данные пользователя'); ?></h4>
					<div class="row">
					...
					<div class="row">
						...
						<div class="hint"><?php echo Yii::t('OrdersModule', 'Применить скидку для общей суммы заказа'); ?></div>
					</div>

					<div class="row">
						<?php echo CHtml::activeLabel($model,'user_name', array('required'=>true)); ?>
						<?php echo CHtml::activeTextField($model,'user_name'); ?>
						<?php if($model->user_id && !Yii::app()->user->getIsManager()): ?>
						<div class="hint">
							<?php echo CHtml::link(Yii::t('OrdersModule', 'Редактировать пользователя'), array(
					...
					<div class="row">
						...
						<div class="hint"><?php echo Yii::t('OrdersModule', 'Этот текст не виден для пользователя.'); ?></div>
					</div>
				</div>
			</td>
			<td>
				...
				<?php if(!$model->isNewRecord): ?>
					<div style="float: right;padding-right: 10px">
						<a href="javascript:openAddProductDialog(<?php echo $model->id ?>);"><?php echo Yii::t('OrdersModule','Добавить продукт') ?></a>
					</div>
					<div id="dialog-modal" style="display: none;" title="<?php echo Yii::t('OrdersModule','Добавить продукт') ?>">
						<?php
					...
					<h4><?php echo Yii::t('OrdersModule','Продукты') ?></h4>
