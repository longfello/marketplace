...
$title = ($model->isNewRecord) ? Yii::t('OrdersModule', 'Создание заказа') :
	Yii::t('OrdersModule', 'Редактирование заказа');
...
$this->breadcrumbs = array(
	...
	Yii::t('OrdersModule', 'Заказы')=>$this->createUrl('index'),
	($model->isNewRecord) ? Yii::t('OrdersModule', 'Создание заказа') :'# '.CHtml::encode($model->id),
);
...
// Render tabs
$tabs = array(
	Yii::t('OrdersModule', 'Заказ') => $this->renderPartial('_order_tab', array(
		'model'           => $model,
		'statuses'        => $statuses,
...
{
	// Add history tab
	$tabs[Yii::t('OrdersModule', 'История')] = array(
