...
Yii::app()->clientScript->registerScript('qustioni18n', '
	var deleteQuestion = "'.Yii::t('OrdersModule', 'Вы действительно удалить запись?').'";
	var productSuccessAddedToOrder = "'.Yii::t('OrdersModule', 'Продукт успешно добавлен к заказу.').'";
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'          => array(
		array(
			'name'=>'renderFullName',
			'type'=>'raw',
			'header'=>Yii::t('OrdersModule', 'Название')
		),
		array(
			'class'=>'OrderQuantityColumn',
			'name'=>'quantity',
			'header'=>Yii::t('OrdersModule', 'Кол.')
		),
		'sku',
		array(
			'name'=>'price',
...
<div align="right">
	<table id="orderSummaryTable">
		...
		<tbody>
			<tr align="right">
				<td><b><?php echo Yii::t('OrdersModule','Цена доставки') ?>:</b></td>
			...
			<tr align="right">
				<td><b><?php echo Yii::t('OrdersModule','Сумма товаров') ?>:</b></td>
			...
			<tr align="right" style="font-size: 14px;">
				<td><b><?php echo Yii::t('OrdersModule','К оплате') ?>:</b></td>
