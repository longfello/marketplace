...
$this->pageHeader = Yii::t('LoggerModule', 'Журнал действий');

$this->breadcrumbs = array(
	'Home'=>$this->createUrl('/admin'),
	Yii::t('LoggerModule', 'Модули')=>Yii::app()->createUrl('/core/admin/systemModules'),
	Yii::t('LoggerModule', 'Журнал действий'),
);
