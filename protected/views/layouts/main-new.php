		...
		<div class="middle">
			...
			<div class="search_box">
				<?php echo CHtml::form($this->createUrl('/store/category/search')) ?>
					<input type="text" value="<?=Yii::t('core','Поиск товаров')?>" name="q" id="searchQuery">
					<button type="submit"><?=Yii::t('core','Поиск')?></button>
...
<div id="footer">
	<div class="centered">
		<div class="left">
			<?=Yii::t('core','© «Интернет магазин»')?>, <?=date('Y')?>
			<span class="light"><?=Yii::t('core','Все права защищены')?></span>
		</div>
