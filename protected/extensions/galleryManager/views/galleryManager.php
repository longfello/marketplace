...
<?php echo CHtml::openTag('div', $this->htmlOptions); ?>
    ...
    <div class="btn-toolbar gform">
        ...
        <div class="btn-group">
            ...
            <span class="btn disabled edit_selected"><i class="glyphicon glyphicon-pencil"></i> <?php echo Yii::t('galleryManager.main', 'Edit');?></span>
            <span class="btn disabled remove_selected"><i class="glyphicon glyphicon-remove"></i> <?php echo Yii::t('galleryManager.main', 'Remove');?></span>
        </div>
    </div>
    <hr/>
    <!-- Gallery Photos -->
